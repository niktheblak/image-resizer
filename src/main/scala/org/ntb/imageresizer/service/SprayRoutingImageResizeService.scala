...
class SprayRoutingImageResizeServiceActor extends Actor with HttpServiceActor with SprayRoutingImageResizeService {
...
trait SprayRoutingImageResizeService extends HttpService {
